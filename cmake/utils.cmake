...
function(git_fetch_content_v2)
    ...
    if (NOT PARSED_ARGS_URL)
        message(FATAL_ERROR "You must provide a URL argument.")
    endif()
    if (NOT PARSED_ARGS_VERSION)
        message(FATAL_ERROR "You must provide a VERSION argument.")
    endif()
...
function(process_proto_file_v2)
    ...
    if (NOT PARSED_ARGS_DEST)
        message(FATAL_ERROR "You must provide a DEST argument.")
    endif()
